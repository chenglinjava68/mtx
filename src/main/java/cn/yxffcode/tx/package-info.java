 ...
 * {@link com.limiku.spider.multimybatis.transaction.SimpleTransactionManager}作为
 * Spring中提供的{@link org.springframework.jdbc.datasource.DataSourceTransactionManager}类
 * 的替代,{@link com.limiku.spider.multimybatis.transaction.MultiDataSourcesTransactionManager}
 * 作为多个数据库的事务管理器的包装.
 * <p/>
 * 在一次完整的事务中,
